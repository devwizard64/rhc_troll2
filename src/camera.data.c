...
DALIGN s32 camera_stage_prev = 0;
...
DALIGN void *camera_8032DF60 = _camera_bss+0x00;
DALIGN void *camera_8032DF64 = _camera_bss+0x24;
...
int (*camera_8032DFA8[])(struct camera *, VECF, VECF) =
{
	NULL,
	camera_80280810,
	camera_802816A0,
