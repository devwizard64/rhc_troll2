...
Gfx gfx_shadow_circle[] =
{
	...
	gsDPLoadTextureBlock(txt_shadow_circle, G_IM_FMT_IA, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR, G_TX_MIRROR, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
	gsSPEndDisplayList(),
};
...
{
	gsSPDisplayList(gfx_shadow_start),
	gsDPLoadTextureBlock(txt_shadow_square, G_IM_FMT_IA, G_IM_SIZ_8b, 16, 16, 0, G_TX_MIRROR, G_TX_MIRROR, 4, 4, G_TX_NOLOD, G_TX_NOLOD),
	gsSPEndDisplayList(),
};
