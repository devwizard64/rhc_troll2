static u16 txt_weather_snow_a[] =
{
#include "a.rgba16.h"
};

Gfx gfx_weather_snow_a[] =
{
	gsDPPipeSync(),
	...
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, txt_weather_snow_a),
...
static u16 txt_weather_snow_b[] =
{
#include "b.rgba16.h"
};

Gfx gfx_weather_snow_b[] =
{
	gsDPPipeSync(),
	gsSPClearGeometryMode(G_SHADING_SMOOTH|G_LIGHTING),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, txt_weather_snow_b),
	gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
	gsDPSetRenderMode(G_RM_AA_ZB_TEX_EDGE, G_RM_AA_ZB_TEX_EDGE2),
	gsSPTexture(0x8000, 0x8000, G_TX_NOLOD, G_TX_RENDERTILE, G_ON),
	gsDPLoadTextureBlockN(G_IM_FMT_RGBA, G_IM_SIZ_16b, 16, 16, 0, G_TX_WRAP, G_TX_WRAP, G_TX_NOMASK, G_TX_NOMASK, G_TX_NOLOD, G_TX_NOLOD),
	gsSPEndDisplayList(),
};

Gfx gfx_weather_lava_start[] =
{
	gsDPPipeSync(),
	gsSPClearGeometryMode(G_SHADING_SMOOTH|G_LIGHTING),
	gsDPSetCombineMode(G_CC_DECALRGBA, G_CC_DECALRGBA),
